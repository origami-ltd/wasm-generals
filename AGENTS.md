...
https://github.com/origami-ltd/wasm-generals, adding one row to PROOF_OF_USAGE.md:
...
```
Includes material from origami-ltd/wasm-generals — https://generals.wasm.ltd
...
https://github.com/origami-ltd/wasm-generals
