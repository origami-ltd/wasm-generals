...
**Branch Strategy Change**: 🔄 **PLANNED** - Promote `linux-attempt` → `main`
- Current `main` (SDL2 + Wine/DX9) archived as `old-main-sdl2` (non-functional)
- `linux-attempt` (SDL3 + DXVK native) to become official direction
- Ready for promotion after Session 41 documentation
