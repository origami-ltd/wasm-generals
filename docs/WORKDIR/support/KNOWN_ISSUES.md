# GeneralsX Zero Hour — Known Issues

## ISSUE-01: Shell Map Units Immortal Under Bombardment (Resolved WideChar Bug in Session 51)
...
- **Dev diary**: `docs/DEV_BLOG/2026-02-DIARY.md` — Session 51 entry
- **Lessons**: `docs/WORKDIR/lessons/2026-02-LESSONS.md` — LESSON-51 (WideChar/UTF-16LE ABI)
...
**Component**: [Graphics|Audio|Gameplay|Platform|Build]
