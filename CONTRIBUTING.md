...
This port wraps [GeneralsX](https://github.com/fbraz3/GeneralsX), itself built on EA's source
release. If your change is about how the game *behaves*, it almost certainly belongs there rather
than here — and note that the engine is GPL-3.0, so a patch to it is offered under those terms,
not under the licence covering the page. If it is about how the game **runs in a browser** — the Emscripten build, the platform
...
branch — `npx setup-ai-provenance-license record --repo https://github.com/origami-ltd/wasm-generals` posts the same fields to
https://generals.wasm.com.br/api/proof-of-usage, which opens the pull request for you and replies with its
...
```
Includes material from https://github.com/origami-ltd/wasm-generals
